...
parser.add_argument('--use_HDFE', type=int, default=0, help='1 if using HDFE and 0 otherwise')
...
if FLAGS.mode == 'train':
    ...
    os.system('CUDA_VISIBLE_DEVICES={} python train.py --dataset_root={} --trainset_list={} --patch_size={} --batch_size={} \
                                                    --num_knn={} --decode_knn={} --lr={} --resume={} --use_HDFE={}'.format(
                gpu, dataset_root, trainset_list, train_patch_size, train_batch_size, num_knn, decode_knn, lr, resume, use_HDFE))
    ...
    command = 'python test.py --gpu={} --dataset_root={} --data_set={} --log_root={} --ckpt_dirs={} --ckpt_iters={} \
                            --patch_size={} --batch_size={} --num_knn={} --decode_knn={} --save_pn={} --sparse_patches={} --use_HDFE={}'.format(
            gpu, dataset_root, data_set, log_root, ckpt_dirs, ckpt_iters, test_patch_size, test_batch_size, num_knn, decode_knn, save_pn, sparse_patches, use_HDFE)
